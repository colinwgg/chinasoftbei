...
class Ws_Param(object):
    ...
    def __init__(self, APPID, APIKey, APISecret, Spark_url):
        self.APPID = "777b23bb"
        self.APIKey = "f1935f643ee6f8de9ad503940e8497d8"
        self.APISecret = "ZGIxOGFiNjBjNjBkYjZiMmUyYTIwYTM1"
...
if __name__ == '__main__':
    ...
    appid = "777b23bb"  # 填写控制台中获取的 APPID 信息
    api_secret = "ZGIxOGFiNjBjNjBkYjZiMmUyYTIwYTM1"  # 填写控制台中获取的 APISecret 信息
    api_key = "f1935f643ee6f8de9ad503940e8497d8"  # 填写控制台中获取的 APIKey 信息
    domain = "x1"       #控制请求的模型版本
    # 服务地址
